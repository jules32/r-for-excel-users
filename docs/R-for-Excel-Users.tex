...
Agenda for our 2-day pilot workshop:
...
break & &\tabularnewline
11-12:30 & \protect\hyperlink{github}{GitHub} & \protect\hyperlink{dplyr-pivot-tables}{\texttt{dplyr} \& Pivot Tables}\tabularnewline
lunch & &\tabularnewline
...
We are Dr.~Julie Lowndes and Dr.~Allison Horst. We are environmental scientists who use and teach R in our daily work. We are both at UCSB, where Julie is based at NCEAS as part of the Ocean Health Index team and leads Openscapes, and Allison is based at Bren as a lecturer of data science \& statistics and is also an Artist in Residence at RStudio.

This workshop you will learn hands-on how to begin to interoperate between Excel and R. But this is not only about learning R; we will learn R using additional software: RStudio and GitHub. These tools will help us develop good habits for working in a reproducible and collaborative way --- critical attributes of the modern analyst.
...
Excel is a widely used and powerful tool for working with data. We all work with it or with people who use it daily. This is convenient and familiar; most of us in this modern world have had their first experiences with data through Excel or other spreadsheet programs. As Jenny Bryan has said, \href{}{``Excel is how we learn that we love data analysis''}.

However, as automation, reproducibility, collaboration, and frequent reporting become increasingly expected in data analysis, a good option for Excel users is to extend their workflows with R. Integrating R into data analysis with Excel can bridge the technical gap between collaborators using either software. R enables use of existing tools built for specific tasks and overcomes some limitations that arise when working with large datasets or repeated analyses.

There are technical skills we will develop today in this workshop to help us along this way. But a big part of interfacing between Excel and R is not only skillsets, it is mindsets.

Excel blends data and analysis into the same place. But we will talk about keeping data separate from analyses. ``Keeping the raw data raw.'' And further, we will think about the shape and organization of data, and how we can set this up in the present to make our future analytical self's life easier.

R and Excel are both great tools that are powerful for different tasks.
...
We are not only learning R; we will learn a workflow with R and GitHub. We will practice learning three main things all at the same time:
...
\item
  and communication/publishing (RMarkdown/GitHub).
\end{enumerate}

This training will teach these all together to reinforce skills and best practices, and get you comfortable with a workflow that you can use in your own projects, and interface with Excel in your own analyses and with collaborators.

\hypertarget{what-to-expect}{%
\subsection{What to expect}\label{what-to-expect}}

This is going to be a fun and empowering workshop.

This is not about wholesale replacing the tasks you do in Excel into R, but helping you incrementally include R into your Excel workflows. But a big part of this incremental transition is the \textbf{\emph{mindset}} around data and analysis. Excel makes it easy to have data and analyses in the same file --- and even in the same sheet or column:

TODO: screenshot of Excel
...
\includegraphics{R-for-Excel-Users_files/figure-latex/unnamed-chunk-57-1.pdf}
...
\includegraphics{R-for-Excel-Users_files/figure-latex/unnamed-chunk-92-1.pdf}
...
\includegraphics{R-for-Excel-Users_files/figure-latex/unnamed-chunk-92-2.pdf}
...
\paragraph{Activity}\label{activity-4}}
