...
This is going to be fun, because learning R (and friends) is empowering!

\hypertarget{agenda-pilot-workshop}{%
\subsection{Agenda: pilot workshop}\label{agenda-pilot-workshop}}
...
\textbf{This workshop is not about wholesale replacing everything you do in Excel into R}. Instead, it is to give you hands-on experience and confidence with R, and how to interoperate between Excel and R. Incorporating R into your own workflows will be incremental, and a big part of this transition is the \textbf{\emph{mindset}} around data and your analytical workflow.
...
\textbf{An R user also keeps raw data separate from their analyses}, which means having data in one file and written computational commands saved as a separate file. We also think more and more about what we call ``Tidy data'', where the data has a rectangular shape and each column is a variable and each row is an observation. Tidy data is a way of life.

\includegraphics[width=0.7\linewidth]{img/tidy_img_np}

There are technical skills we will develop today in this workshop to help us along this way. But a big part of interfacing between Excel and R is not only skillsets, it is mindsets. It is the mindset about how we think about data. How we shape data and organize data and analyze data. And how what we do now can make our analytical life better in the future.
