...
# This is the final curated version (lobster_counts_curated.csv)
write_csv(lobster_subset, "curation/lobster_counts_curated.csv")

# Make a graph of the numbers by location, year & species?
# Probably want to work on this a bit more ()

ggplot(lobster_subset, aes(x = year, y = count)) +
