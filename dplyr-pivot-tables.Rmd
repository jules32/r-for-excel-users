...
## read in data
lobsters <- read_xlsx(here("data/lobsters_curated.xlsx"))
```
...
library(here)
library(skimr)
lobsters <- read_xlsx(here("curation/lobsters_curated.xlsx"))
```
...
```{r, eval=FALSE}
## read in data
lobsters <- read_xlsx(here("data/lobsters2_curated.xlsx"))
```
