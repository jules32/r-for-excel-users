...
abur_kelp_join <- fish_counts %>% 
  full_join(kelp_counts_abur) # Hmmm year isn't numeric in kelp_counts_aburr (deal with this or use something else?) Can do a mutate(as.numeric()) here to update year in kelp_counts? TODO too much?
```
