...
![dplyr::filter()](img/rstudio-cheatsheet-filter.png)
...
![dplyr::joins](img/rstudio-cheatsheet-combine-options1.png)
...
- The risk of partial joins (& the case for full_join + drop_na instead)
