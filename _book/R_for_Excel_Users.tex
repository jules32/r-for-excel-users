...
\includegraphics{R_for_Excel_Users_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\includegraphics{R_for_Excel_Users_files/figure-latex/unnamed-chunk-38-1.pdf}
...
\includegraphics{R_for_Excel_Users_files/figure-latex/unnamed-chunk-45-1.pdf}
...
\NormalTok{fish_counts }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(site, year) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{siteyear_counts =} \KeywordTok{sum}\NormalTok{(total_count))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fish_percs <-}\StringTok{ }\NormalTok{fish_counts }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(site, year) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{siteyear_counts =} \KeywordTok{sum}\NormalTok{(total_count)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{perc_fish =}\NormalTok{ total_count}\OperatorTok{/}\NormalTok{siteyear_counts}\OperatorTok{*}\DecValTok{100}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## first calculate fish siteyear_counts}
\NormalTok{x <-}\StringTok{ }\NormalTok{fish_counts }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(site, year) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{siteyear_counts =} \KeywordTok{sum}\NormalTok{(total_count)) }

\CommentTok{## then somehow join or merge that information to the fish_counts data }
