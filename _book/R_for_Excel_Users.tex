...
\item
  Read in multiple Excel worksheets (note to Julie: I actually think this is fine to include\ldots{}purrr::map() can be explained in a really simple way)
\item
  Something about readxl workflows (e.g. \%\textgreater{}\% write\_csv())
\end{enumerate}
...
\chapter{Better practices {[}needs a better name{]}}\label{better-practices-needs-a-better-name}}
