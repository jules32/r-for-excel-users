...
\item
  \href{https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005510\#}{Good enough practices for scientific computing}
\end{itemize}
...
Some big themes from Good enough practices in scientific computing. In terms of data management, they have 2 main themes:
...
We are going to focus on both of these, using R and discussing the similarities and differences between R and Excel, and how to interoperate between them.
...
\DecValTok{38}\OperatorTok{*}\DecValTok{40}
\end{Highlighting}
\end{Shaded}
